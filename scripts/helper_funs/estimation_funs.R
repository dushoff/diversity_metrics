...
checkchao<-function(x, B, l, truediv){ #, truemu_n
  ...
  chaotile<-findInterval(truediv, quantile(pro, seq(0,1,0.0005)), left.open = T)/20#(sum(pro<truediv)+1)/((B+1)/100) #I think this is a good percentile estimate based on North et al. 2002? This has a clear tie-breaking bias in one direction
